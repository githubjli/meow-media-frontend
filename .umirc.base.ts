...
export default defineConfig({
  ...
  routes: [
    ...
    },
    {
      ...
      component: './Account/ShippingAddresses',
      hideInMenu: true,
    },
    {
      path: '/account/product-orders',
      component: './Account/ProductOrders',
      hideInMenu: true,
    },
    {
      path: '/account/product-orders/:order_no',
      component: './Account/ProductOrders/Detail',
      hideInMenu: true,
    },
    ...
    {
      path: '/seller/orders/:order_no',
      component: './Seller/Orders/Detail',
      hideInMenu: true,
    },
    {
      path: '/seller/payout-addresses',
      component: './Seller/PayoutAddresses',
      hideInMenu: true,
    },
    {
      path: '/seller/refund-requests',
      component: './Seller/RefundRequests',
      hideInMenu: true,
    },
    {
