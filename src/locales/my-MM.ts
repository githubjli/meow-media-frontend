export default {
  ...
  'nav.myLibrary': 'ကျွန်ုပ်၏ Library',
  'nav.videoCreator': 'Video Creator',
  'nav.liveCreator': 'Live Creator',
  'nav.dramaCreator': 'Drama Creator',
  'nav.creatorCenter': 'Creator Center',
  'nav.walletBilling': 'Wallet နှင့် Billing',
  'nav.linkedWallet': 'Linked Wallet',
  'nav.adminCenter': 'Admin Center',
  'nav.continueWatching': 'ဆက်လက်ကြည့်ရှုမည်',
  'nav.favoriteDrama': 'နှစ်သက်သော ဒရာမာ',
  'nav.unlockedEpisodes': 'ဖွင့်ပြီးသော အပိုင်းများ',
  'nav.myLive': 'ကျွန်ုပ်၏ Live',
  'nav.myDrama': 'ကျွန်ုပ်၏ ဒရာမာ',
  'nav.uploadDrama': 'Drama တင်မည်',
  'nav.meowPoints': 'Meow Points',
  'nav.rechargeMeowPoints': 'Meow Points ဖြည့်သွင်းမည်',
  'nav.meowPointsLedger': 'Meow Points စာရင်းမှတ်တမ်း',
  ...
  'meowPoints.subtitle':
    'လက်ကျန်ငွေ၊ ဝယ်ယူနိုင်သော package များနှင့် လတ်တလော ledger ကို ကြည့်ရှုပါ။',
  'meowPoints.error.load': 'Meow Points အချက်အလက်ကို ယခုမတင်နိုင်ပါ။',
  'meowPoints.actions.recharge': 'Meow Points ဖြည့်သွင်းမည်',
  'meowPoints.wallet.currentBalance': 'လက်ရှိလက်ကျန်',
  'meowPoints.wallet.totalPurchased': 'စုစုပေါင်းဝယ်ယူမှု',
  'meowPoints.wallet.totalBonus': 'စုစုပေါင်းဘောနပ်စ်',
  'meowPoints.wallet.totalSpent': 'စုစုပေါင်းအသုံးပြုမှု',
  'meowPoints.packages.title': 'ရနိုင်သော Package များ',
  'meowPoints.packages.empty': 'Meow Points package မရှိသေးပါ။',
  'meowPoints.packages.points': 'Points',
  'meowPoints.packages.price': 'စျေးနှုန်း',
  'meowPoints.ledger.title': 'လတ်တလော Ledger',
  'meowPoints.ledger.viewAll': 'အားလုံးကြည့်မည်',
  'meowPoints.ledger.empty': 'ledger မှတ်တမ်းမရှိသေးပါ။',
  'meowPoints.ledger.balanceAfter': 'လုပ်ဆောင်ပြီးနောက် လက်ကျန်',
  'meowPoints.recharge.title': 'Meow Points ဖြည့်သွင်းမည်',
  'meowPoints.recharge.subtitle':
    'Package တစ်ခုရွေးပြီး THB-LTT order တစ်ခုဖန်တီးပါ။',
  'meowPoints.recharge.empty': 'အသုံးပြုနိုင်သော package မရှိသေးပါ။',
  'meowPoints.recharge.buyNow': 'ယခုဝယ်မည်',
  'meowPoints.recharge.error.load': 'Meow Points package များကို မတင်နိုင်ပါ။',
  'meowPoints.recharge.error.create': 'Recharge order ဖန်တီး၍ မရပါ။',
  'meowPoints.order.title': 'Meow Points Order',
  'meowPoints.order.subtitle': 'Order No: {orderNo}',
  'meowPoints.order.error.load': 'ဤ order ကို မတင်နိုင်ပါ။',
  'meowPoints.order.error.txHint': 'TXID hint ပို့၍ မရပါ။',
  ...
  'meowPoints.order.pending': 'Payment အတည်ပြုချက် စောင့်နေသည်',
  'meowPoints.order.pendingHint':
    'အထက်ပါ address သို့ THB-LTT ကို တိတိကျကျပေးချေပါ။ status ကို auto refresh လုပ်ပါမည်။',
  'meowPoints.order.submitTxHint': 'TXID Hint ပို့မည်',
  'meowPoints.order.txHintPlaceholder': 'Transaction ID ထည့်ပါ (optional)',
  'meowPoints.order.txHintSent': 'TXID hint ပို့ပြီးပါပြီ။',
  'meowPoints.order.paid': 'ငွေပေးချေမှုအောင်မြင်ပြီး points ထည့်သွင်းမည်။',
  'meowPoints.order.failedLike':
    'ဤ order သည် expired/cancelled/failed ဖြစ်ပါသည်။ အသစ်ပြန်ဖန်တီးပါ။',
  'meowPoints.order.backToWallet': 'Wallet သို့ပြန်မည်',
  'meowPoints.order.backToRecharge': 'Recharge သို့ပြန်မည်',
  'meowPoints.order.copied': 'Copied',
  'meowPoints.order.copyFailed': 'Copy မအောင်မြင်ပါ',
  'drama.title': 'ဒရာမာ',
  'drama.subtitle':
    'Series တိုများကို ရှာဖွေပြီး episode များကို unlock လုပ်ကာ ဆက်လက်ကြည့်ရှုပါ။',
  'drama.empty': 'ဒရာမာ series မရှိသေးပါ။',
  ...
  'drama.error.loadList': 'Drama list မတင်နိုင်ပါ။',
  'drama.error.loadDetail': 'Drama detail မတင်နိုင်ပါ။',
  'drama.error.loadEpisodes': 'Episodes မတင်နိုင်ပါ။',
  'drama.error.favoriteOperation': 'Favorite အပြောင်းအလဲ မလုပ်နိုင်ပါ။',
  ...
  'drama.detail.noEpisodes': 'Episode မရှိသေးပါ။',
  ...
  'drama.creator.list.empty': 'ဖန်တီးထားသော drama မရှိသေးပါ။',
  'drama.creator.list.error.load': 'သင့် drama list ကို မဖွင့်နိုင်ပါ။',
  'drama.creator.permissionDenied':
    'Drama စီမံရန် creator အခွင့်အရေးလိုအပ်သည်။',
  ...
  'drama.creator.fields.tagsHint': 'Tag များကို comma ဖြင့်ခွဲပါ။',
  ...
  'drama.creator.fields.totalEpisodes': 'Episodes စုစုပေါင်း',
  ...
  'drama.creator.actions.createDrama': 'Drama ဖန်တီးမည်',
  'drama.creator.actions.saveChanges': 'အပြောင်းအလဲသိမ်းမည်',
  'drama.creator.actions.createEpisode': 'Episode ဖန်တီးမည်',
  'drama.creator.actions.edit': 'ပြင်ဆင်မည်',
  'drama.creator.actions.episodes': 'Episodes',
  'drama.creator.actions.preview': 'Preview',
  'drama.creator.actions.delete': 'ဖျက်မည်',
  'drama.creator.delete.success': 'Drama ဖျက်ပြီးပါပြီ။',
  'drama.creator.delete.failed': 'Drama မဖျက်နိုင်ပါ။',
  'drama.creator.delete.unsupported': 'Backend မှ delete မပံ့ပိုးသေးပါ။',
  'drama.creator.form.new.title': 'Drama ဖန်တီးမည်',
  'drama.creator.form.new.subtitle': 'သင်၏ short drama series ကိုသတ်မှတ်ပါ။',
  'drama.creator.form.edit.title': 'Drama ပြင်ဆင်မည်',
  'drama.creator.form.edit.subtitle':
    'Drama အသေးစိတ်အချက်အလက်များကို update လုပ်ပါ။',
  'drama.creator.form.create.success': 'Drama ဖန်တီးပြီးပါပြီ။',
  'drama.creator.form.update.success': 'Drama update ပြီးပါပြီ။',
  'drama.creator.form.error.load': 'Drama detail မဖွင့်နိုင်ပါ။',
  'drama.creator.form.error.submit': 'Drama form မသိမ်းနိုင်ပါ။',
  'drama.creator.episodes.title': 'Episodes · {title}',
  'drama.creator.episodes.defaultTitle': 'Drama',
  'drama.creator.episodes.subtitle': 'ဤ series အတွက် episodes များကို စီမံပါ။',
  'drama.creator.episodes.empty': 'Episodes မရှိသေးပါ။',
  'drama.creator.episodes.error.notFound': 'Drama series မတွေ့ပါ။',
  'drama.creator.episodes.error.load': 'Episodes မဖွင့်နိုင်ပါ။',
  'drama.creator.episodes.error.submit': 'Episode save မလုပ်နိုင်ပါ။',
  'drama.creator.episodes.create.success': 'Episode ဖန်တီးပြီးပါပြီ။',
  'drama.creator.episodes.update.success': 'Episode update ပြီးပါပြီ။',
  'drama.creator.episodes.delete.success': 'Episode ဖျက်ပြီးပါပြီ။',
  'drama.creator.episodes.delete.failed': 'Episode မဖျက်နိုင်ပါ။',
  'drama.creator.episodes.modal.createTitle': 'Episode ဖန်တီးမည်',
  'drama.creator.episodes.modal.editTitle': 'Episode ပြင်ဆင်မည်',
  ...
  'video.access.label': 'ကြည့်ရှုခွင့်',
  'video.access.required': 'ကြည့်ရှုခွင့်အမျိုးအစားကို ရွေးပါ။',
  'video.access.free': 'အခမဲ့',
  'video.access.membersOnly': 'အသင်းဝင်များသာ',
  'video.access.vip': 'VIP',
  'video.access.locked': 'လော့ခ်ထားသည်',
