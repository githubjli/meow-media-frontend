export default {
  ...
  'auth.common.proxyNotice': "Your requests will use the app's local /api proxy.",
  ...
  'auth.register.error.tokens': 'Registration succeeded but tokens were not returned.',
